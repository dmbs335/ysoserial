...
/*
	DefaultedMap entry point — bypasses HashMap/HashSet/Hashtable/PQ/TreeBag filters.
	...
	DefaultedMap is a Map decorator that returns a default value for missing
	keys. Sibling class of LazyMap — same decorator pattern but different
	class name. Has its own readObject that reconstructs the backing map
	via put(), triggering hashCode.

	Filter evasion:
		1. DefaultedMap (o.a.c.c.map) — not in any known filter
...
public class CommonsCollections30 extends PayloadRunner implements ObjectPayload<Serializable> {
